...
select user_type,avg(Completed_goals_per_user) as Average_User from 
  (select user_id,user_type,count(*) as Completed_goals_per_user from user_goals 
  where goal_status='Completed' group by user_id,user_type) 
